 ...
 * $Id: I3GENIEGenerator.cxx 167149 2018-11-28 23:02:45Z claudio.kopper $
 *
 * @file I3GENIEGenerator.cxx
 * @version $Revision$
 * @date $Date: 2018-11-28 15:02:45 -0800 (Wed, 28 Nov 2018) $
...
myTRandom(NULL)
{
    ...
    AddParameter("PositionShift",
                 "Vector defining the shift applied to all particle positions obtained from GENIE",
                 positionShift_);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    GetParameter("PositionShift", positionShift_);
    ...
    if(!random_)
        log_fatal("No random service specified");
...
#endif
{
    ...
    */
    ...
    const bool success = I3GENIE_Helper::ConvertToMCTree(mcTree,weightDict,gstMap,positionShift_);
    if(!success)
