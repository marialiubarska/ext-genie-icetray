...
i3env=/home/mliubar/my_icetray_Wcut0/full_build/env-shell.sh
echo "Will use i3 environment: " ${i3env}
script=/home/mliubar/Software/genie_workspace/testing/scripts/ext_prod/ext_step1_genie.sh
...
OUTNAME=${OUTDIR}/${FLV}_${E}_${RUNNUM}_${FILE_NR}_step1.zst
